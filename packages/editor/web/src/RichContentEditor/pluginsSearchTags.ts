...
const getRelatedPlugins = (searchTag: string, t: TranslationFunction) => {
...
export const getPluginsForTag = (searchTag: string, t: TranslationFunction) =>
  getRelatedPlugins(searchTag, t).map(data => data.plugin);

export const getPluginsIdForTag = (searchTag: string, t: TranslationFunction) =>
