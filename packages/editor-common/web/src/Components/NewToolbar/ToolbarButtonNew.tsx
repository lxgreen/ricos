...
class ToolbarButtonNew extends Component<ToolbarButtonProps> {
...
export default React.forwardRef<ToolbarButtonNew, ToolbarButtonProps>((props, ref) => (
  <ToolbarButtonNew forwardRef={ref} {...props} />
));

export type ToolbarButtonType = ToolbarButtonNew;
