...
import { mockFileUploadFunc, mockImageNativeUploadFunc } from '../../shared/utils/fileUploadUtil';
import { MockVerticalSearchModule } from '../../shared/utils/verticalEmbedUtil';
const tiptapContent = {
  type: 'doc',
  attrs: {
    metadata: {
