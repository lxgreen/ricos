...
`buttonKey` represents the current button. for example, one of the values of `FORMATTING_BUTTONS` that can be found in [consts.ts](https://github.com/wix/ricos/blob/master/packages/editor-common/web/src/consts.ts)(`'Bold'`, `'Italic'`, `'LINK'`, etc..).
...
All the toolbar types are exposed by the `TOOLBARS` const found in [consts.ts](https://github.com/wix/ricos/blob/master/packages/editor-common/web/src/consts.ts).
...
| `buttonsOverrides`       | a map of buttons to override the default buttons configuration                                                                                                                                                                                                     | all v2 toolbars                             |
