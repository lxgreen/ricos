...
`buttonKey` represents the key of a current button (most likely to be one of the buttons const found in [consts.js](https://github.com/wix/ricos/blob/master/packages/editor-common/web/src/consts.js), but also can be a custom button key that can be passed by `getButtons`).
...
| `buttonsOverrides`          | a map of buttons to override the default buttons configuration                                                                                                                                                                                                     | all new toolbars                            |
